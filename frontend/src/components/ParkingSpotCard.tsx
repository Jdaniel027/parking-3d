  ...
  return (
    <button onClick={() => onClick(spot.id)}
      className={`flex flex-col items-center justify-center gap-1 w-full h-auto py-3 px-2 rounded-xl text-xs font-bold
        transition-all duration-150 ease-in-out border select-none
        active:scale-[0.94] focus-visible:ring-2 focus-visible:ring-cyan-accent/40 focus-visible:outline-none
        ${occ ? "bg-coral-soft/10 border-coral-soft/30 hover:bg-coral-soft/20 hover:border-coral-soft/50 active:bg-coral-soft/30" : "bg-lime-soft/10 border-lime-soft/30 hover:bg-lime-soft/20 hover:border-lime-soft/50 active:bg-lime-soft/30"}`}>
